...
router.get("/",(req,res)=>{
  ...
  const data = JSON.stringify(friends, null,4)

  res.send(data)//This line is to be replaced with actual return value
});

// GET by specific ID request: Retrieve a single friend with email ID
router.get("/:email",(req,res)=>{
  // Update the code here
  const matchEmail = friends[req.params.email]
  res.send(matchEmail)//This line is to be replaced with actual return value
});
